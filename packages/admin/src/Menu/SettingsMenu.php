...
class SettingsMenu
{
    ...
    {
        $storeSection = $this->slot->section('store')->name(__('adminhub::settings.section.store'));
    ...
    {
        $productSection = $this->slot->section('product')->name(__('adminhub::settings.section.products'));
    ...
    {
        $adminSection = $this->slot->section('admin')->name(__('adminhub::settings.section.admin'));
